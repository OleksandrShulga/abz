...
@section('content')
    ...
    <h4>Короткий звіт:</h4>
    <p>Те, що перший пункт ТЗ не просто загальні побажання по підходу, а посилання на цілком конкретну заготовку, роздивився вже коли були готові всі інші пункти. Тож прийшлося дещо переробити, але зрештою сайт функціональний, хоча один метод залишив так як є, бо робив в вихідні. Потім в будні дні Анастасія звернула увагу на Свагер (за що вдячний), перероблював, орієнтуючись на нього</p>
    <p>Спочатку про зображення — про них в заготовці з п.1 ТЗ нічого не сказано, тож технічну реаліззацію зробив на свій розсуд. Форма завантаження знаходиться на сайті за адресою /image/upload. Збереження йде в локальний Storage.</p>
    ...
    <p>Потім переробив. В чому справа? По свагеру, токен все ж треба було використовувати при реєстрації користувача, тому додав і його використання включно з перевіркою. Також трохи протиречить опис по виведенню користувачів. По свагеру, там повинно бути ряд явно видних сторінок. Але кнопка Show more текстом прописана так, що, зрозумів, просто виводяться юзери пертіями по 6 штук. Тут відштовхувався від розуміння тексту</p>
    <p></p>
    <p>
    ...
    <ol>
        ...
        <li>Зміни після вказіки про частково неправильну інтерпритацію технічного завдання — чотири години</li>
    </ol>
@endsection
